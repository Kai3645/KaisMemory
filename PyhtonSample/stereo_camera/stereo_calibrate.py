...
if __name__ == '__main__':
	...
	mat_L = np.asarray([370.7673, 0, 603.3985, 0, 370.6573, 349.1074, 0, 0, 1]).reshape((3, 3))
	mat_R = np.asarray([373.2465, 0, 626.9151, 0, 373.3987, 363.1092, 0, 0, 1]).reshape((3, 3))
	dist_L = np.asarray([2.85760726, 4.60387629, 0.00014143, 0.00221237,
	                     0.06523993, 2.58364108, 3.89364134, 0.42966194,
	                     -0.00247370, 0.00001714, -0.00042481, -0.00004474,
	                     0.00310306, 0.00342365])
	dist_R = np.asarray([2.50764566, 3.69586221, 0.00208109, 0.00235887,
