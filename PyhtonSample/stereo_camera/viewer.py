...
def main():
	mat_L = np.asarray([372.4407, 0, 626.7559, 0, 372.5443, 362.9187, 0, 0, 1]).reshape([3, 3])
	mat_R = np.asarray([371.7238, 0, 603.0837, 0, 371.6990, 349.0501, 0, 0, 1]).reshape([3, 3])
	dist_L = np.asarray([2.85419397, 4.41270687, 0.00016594, 0.00290789, 0.07042960, 2.57469084,
	                     3.74501496, 0.42086447, -0.00147710, -0.00023769, -0.00066186, 0.00004257,
	                     0.00026240, 0.01072015])
	dist_R = np.asarray([2.58339740, 4.27790321, -0.00000468, 0.00133856, 0.04181726, 2.31375616,
	                     3.64480336, 0.37388115, -0.00173613, 0.00014957, -0.00010390, -0.00005456,
	                     0.00259686, 0.00150627])
	R = np.asarray([0.99990214, -0.00524353, -0.01297007,
	                0.00522852, 0.99998562, -0.00119088,
	                0.01297612, 0.00112295, 0.99991518]).reshape([3, 3])
	T = np.asarray([0.0623, 0.0001, 0.0011]).reshape([3, 1])
